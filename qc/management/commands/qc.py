...
class Command(BaseCommand):
    ...
    def run_qc(from_ts_utc, to_ts_utc):
        ...
        """
        try:
            locations = db.get_location_info_by_locations()
        except: 
        ...
        for location in locations:
            ...
            sensor_names = db.get_sensor_names_by_location(location_name)
            
            for location_sensor in sensor_names:
                sensor_name = location_sensor.sensor
                params = config_parser_ids.get('RAW_FILE_ORDERS', sensor_name).split(',')
